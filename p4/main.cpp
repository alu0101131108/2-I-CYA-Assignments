...
int main(int argc, char** argv)
{
  if(argc == 3)
  {
    ...
    vector<char> caracteres = {'/', '*', '\n'};           // Corresponde a las columnas de la tabla, sin añadir el caso other.

    vector<int> aux_v(4, -1);
    vector<vector<int>> tabla_transicion(5, aux_v);       // La última columna corresponderá al caso other.
  ...
  else      // Mensaje de ayuda.
  {
    cout << "El programa se usa de la forma: ./exe 'nombre_entrada.txt' 'nombre_salida.txt'" << endl;
    cout << "Leerá y analizará el archivo de entrada borrando los comentarios tipo C o C++. Se volcará el resultado en el archivo de salida." << endl;
  }
  return 0;
}
